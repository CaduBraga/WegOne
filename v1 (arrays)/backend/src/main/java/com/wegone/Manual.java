...
public class Manual {
        ...
        public Manual(String titulo, Date dataDePublicacao, String autor, String texto, TipoManual tipo) {
                this.titulo = titulo;
        ...
        public static void carregarIdioma(JSONObject root) {
                ...
                // método para evitar erros ao puxar idioma
        }
        ...
        public void imprimir() {
                ...
                traduzir("type");
                System.out.println(tipo.getDescricaoTraduzida());
                System.out.println("----------------------------");
        }
        ...
        public void editarData() {
                ...
                traduzir("updated-date");
                System.out.println(getDataDePublicacao());
        }
        ...
        public void editarTipo() {
                ...
                TipoManual[] tipos = TipoManual.values();
                int opcao;
                TipoManual novoTipo = null;

                do {
                        traduzir("current-manual-type");
                        System.out.println(this.tipo.getDescricaoTraduzida());

                        traduzir("select-new-type");
                        for (int i = 0; i < tipos.length; i++) {
                                System.out.printf("%d - %s%n", i + 1, tipos[i].getDescricaoTraduzida());
                        }

                        traduzir("enter-option-number");
                        System.out.print("> ");
                        ...
                        novoTipo = tipos[opcao - 1];

                        if (novoTipo == this.tipo) {
                                traduzir("equals-type");
                                novoTipo = null;
                        }
                ...
                this.tipo = novoTipo;
                traduzir("type-updated");
                System.out.println(this.tipo.getDescricaoTraduzida());
        }

        public static Manual[] imprimirManuais() {
                Manual[] manuais = new Manual[50];

                manuais[0] = new Manual("Manutenção de Motores Elétricos", new Date(), "Carlos Braga",
                                ...
                                TipoManual.MANUTENCAO);

                manuais[1] = new Manual("Manutenção de Transformadores", new Date(), "João Silva",
                ...
                manuais[2] = new Manual("Manutenção de Geradores", new Date(), "Maria Oliveira",
                ...
                manuais[3] = new Manual("Manutenção de Inversores de Frequência", new Date(), "Ana Souza",
                ...
                manuais[4] = new Manual("Manutenção de Bombas Industriais", new Date(), "Fernando Lima",
                ...
                manuais[5] = new Manual("Manutenção de Compressores", new Date(), "Paula Mendes",
                ...
                manuais[6] = new Manual("Manutenção de Painéis Elétricos", new Date(), "Ricardo Alves",
                ...
                manuais[7] = new Manual("Manutenção de Sistemas de Ventilação", new Date(), "Juliana Rocha",
                ...
                manuais[8] = new Manual("Manutenção de CLPs", new Date(), "Diego Costa",
                ...
                manuais[9] = new Manual("Manutenção de Esteiras Transportadoras", new Date(), "Larissa Martins",
                ...
                manuais[10] = new Manual("Manual de Operação de Motores Elétricos", new Date(), "Carlos Braga",
                ...
                manuais[11] = new Manual("Manual de Operação de Transformadores", new Date(), "João Silva",
                ...
                manuais[12] = new Manual("Manual de Operação de Geradores", new Date(), "Maria Oliveira",
                ...
                manuais[13] = new Manual("Manual de Operação de Inversores de Frequência", new Date(), "Ana Souza",
                ...
                manuais[14] = new Manual("Manual de Operação de Bombas Industriais", new Date(), "Fernando Lima",
                ...
                manuais[15] = new Manual("Manual de Operação de Compressores", new Date(), "Paula Mendes",
                ...
                manuais[16] = new Manual("Manual de Operação de Painéis Elétricos", new Date(), "Ricardo Alves",
                ...
                manuais[17] = new Manual("Manual de Operação de Sistemas de Ventilação", new Date(), "Juliana Rocha",
                ...
                manuais[18] = new Manual("Manual de Operação de CLPs", new Date(), "Diego Costa",
                ...
                manuais[19] = new Manual("Manual de Operação de Esteiras Transportadoras", new Date(),
                                "Larissa Martins",
                ...
                manuais[20] = new Manual("Procedimento de Segurança para Instalação de Equipamentos Elétricos",
                                new Date(), "Carlos Braga",
                                ...
                                TipoManual.SEGURANCA);

                manuais[21] = new Manual("Procedimento de Segurança para Operações com Risco de Choque Elétrico",
                                new Date(), "João Silva",
                ...
                manuais[22] = new Manual("Procedimento de Segurança para Trabalhos em Altura", new Date(),
                                "Maria Oliveira",
                ...
                manuais[23] = new Manual("Procedimento de Segurança para Manutenção de Equipamentos Elétricos",
                                new Date(), "Ana Souza",
                ...
                manuais[24] = new Manual("Procedimento de Segurança para Inspeção de Equipamentos Elétricos",
                                new Date(), "Fernando Lima",
                ...
                manuais[26] = new Manual("Procedimento de Segurança para Armazenamento de Materiais Perigosos",
                                new Date(), "Ricardo Alves",
                ...
                manuais[27] = new Manual("Procedimento de Segurança em Sistemas de Iluminação de Emergência",
                                new Date(), "Juliana Rocha",
                ...
                manuais[28] = new Manual("Procedimento de Segurança para Trabalhos com Substâncias Químicas",
                                new Date(), "Diego Costa",
                ...
                manuais[29] = new Manual("Procedimento de Segurança para Uso de Equipamentos de Proteção Individual",
                                new Date(), "Larissa Martins",
                ...
                manuais[30] = new Manual("Conduta no Setor de Montagem", new Date(), "Ana Paula",
                                ...
                                TipoManual.CONDUTA_OPERACIONAL);

                manuais[31] = new Manual("Procedimentos Operacionais no Setor de Manutenção", new Date(),
                                "Ricardo Alves",
                ...
                manuais[32] = new Manual("Processos no Setor de Controle de Qualidade", new Date(), "Fernanda Lima",
                ...
                manuais[33] = new Manual("Diretrizes para o Setor de Logística", new Date(), "Gustavo Pereira",
                ...
                manuais[34] = new Manual("Normas de Segurança no Setor de Produção", new Date(), "Mariana Costa",
                ...
                manuais[35] = new Manual("Padrões de Atendimento ao Cliente", new Date(), "Roberto Souza",
                ...
                manuais[36] = new Manual("Boas Práticas no Setor de Tecnologia da Informação (TI)", new Date(),
                                "Juliana Oliveira",
                ...
                manuais[37] = new Manual("Procedimentos para o Setor de Compras", new Date(), "Lucas Martins",
                ...
                manuais[38] = new Manual("Diretrizes para o Setor de Recursos Humanos (RH)", new Date(),
                                "Camila Rocha",
                ...
                manuais[39] = new Manual("Normas e Procedimentos do Setor Financeiro", new Date(), "Thiago Santos",
                ...
                manuais[40] = new Manual("Testes de Funcionamento de Motores Elétricos", new Date(), "Carlos Braga",
                                ...
                                TipoManual.DIAGNOSTICO);

                manuais[41] = new Manual("Diagnóstico de Falhas em Sistemas de Automação", new Date(), "João Silva",
                ...
                manuais[42] = new Manual("Testes de Funcionamento de Geradores", new Date(), "Maria Oliveira",
                ...
                manuais[43] = new Manual("Diagnóstico de Falhas em Inversores de Frequência", new Date(), "Ana Souza",
                ...
                manuais[44] = new Manual("Testes de Funcionamento de Bombas", new Date(), "Fernando Lima",
                ...
                manuais[45] = new Manual("Diagnóstico de Problemas em Redes Industriais", new Date(), "Mariana Alves",
                ...
                manuais[46] = new Manual("Testes em Sistemas de Lubrificação", new Date(), "Pedro Santos",
                ...
                manuais[47] = new Manual("Diagnóstico de Falhas em Sistemas Hidráulicos", new Date(), "Laura Gomes",
                ...
                manuais[48] = new Manual("Testes em Sistemas de Ventilação e Exaustão", new Date(), "Rafael Nunes",
                ...
                manuais[49] = new Manual("Diagnóstico de Problemas em Instrumentação Industrial", new Date(),
                                "Sofia Castro",
        ...
        public void visualizarTipoManual(String nome, TipoManual tipo) {

        }

        private static void traduzir(String chave) {
                if (mensagensNoIdiomaEscolhido == null) {
                        System.out.println("Erro: as mensagens não foram carregadas corretamente.");
                        return;
                }

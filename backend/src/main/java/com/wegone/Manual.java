...
public class Manual {
        ...
        public void cadastrar() {
                ...
                System.out.print("Digite o autor do manual: ");
                ...
                int opcao;
                TipoManual tipo = null;

                do {
                        System.out.println("Selecione o tipo do manual:");
                        for (int i = 0; i < tipos.length; i++) {
                                System.out.println((i + 1) + " - " + tipos[i].name());
                        }

                        System.out.print("Digite o número correspondente ao tipo desejado: ");
        ...
        public void editarTipo() {
                ...
                do {
                        System.out.println("Tipo atual: " + this.tipo);
                        System.out.println("Selecione o novo tipo do manual:");
                        ...
                        if (novoTipo == this.tipo) {
                                System.out.println("O novo tipo é igual ao atual. Tente novamente.");
                                novoTipo = null;
                        }
                ...
                this.tipo = novoTipo;
                System.out.println("Tipo atualizado para: " + this.tipo);
        }
